          ...
          <div class="col-lg-3 col-md-10  bg-white rounded px-2 " style="height: max-content; ">
            ...
            <div class="search form">
              <form action="/search" method="post" class="p-3">
                ...
                <select class="form-select my-3" aria-label="Default select example" id="locationfilter" name="searchname">
                ...
                <button class="btn" type="submit" style="background-color: #0D2A3A;color: white;">
            ...
            <div class="singleroom col-lg-4 col-md-4 col-xs-4  me-4 "  >
              ...
              <div class="img-ico position-relative " >
                  ...
                  <div class="icons position-absolute bottom-0 d-flex justify-content-between p-3" style="width: 345px;"  >
                      <a href="/show/{{$p['id']}}" class="text-white">${{$p['price']}}/Mo</a>
                      <a href="/show/{{$p['id']}}" class="text-white  "><i class="fa-solid fa-image p-2 rounded" style="background-color: rgba(74, 74, 76, 0.5);" ></i></a>
                      <a href="/show/{{$p['id']}}" class="text-white  "><i class="fa-sharp fa-solid fa-link p-2 rounded" style="background-color: rgba(74, 74, 76, 0.5);" ></i></a>
                  </div>
              </div>
