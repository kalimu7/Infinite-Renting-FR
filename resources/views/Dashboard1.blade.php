    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="sidebar-wrapper" style="background-color: #dee1e4;">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <button href="#" class="list-group-item list-group-item-action bg-transparent second-text fw-bold MPB"><i class="fa-solid fa-house me-2"></i>My properties</button>
                <button href="#" class="list-group-item list-group-item-action bg-transparent second-text fw-bold APB"><i class="fa-solid fa-plus me-2"></i>Add Property</button>
